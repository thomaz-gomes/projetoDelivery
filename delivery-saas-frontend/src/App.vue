...
<template>
  <div :class="isRiderRoute ? 'rider-app' : 'bg-light text-dark'" :style="!isRiderRoute ? 'min-height: 100vh' : ''">
    <template v-if="showLayout">
      ...
      <div class="container-fluid d-flex p-0 flex-column">
        ...
        <!-- Conteúdo -->
        <main class="flex-grow-1 vh-100 main-content" :class="{ 'main-content--flush': isInboxRoute }" :style="{ maxHeight: 'calc(100vh - 64px)', overflowY: isInboxRoute ? 'hidden' : 'auto' }">
          <router-view />
        </main>
      </div>
      <OnboardingWizard
