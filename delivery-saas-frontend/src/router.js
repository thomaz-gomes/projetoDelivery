...
const router = createRouter({
  ...
  { path: '/marketing/brand-themes', component: () => import('./views/BrandThemes.vue'), meta: { requiresAuth: true, role: 'ADMIN' } },
  {
  ...
  ,{ path: '/saas', component: SaasAdmin, meta: { requiresAuth: true, role: 'SUPER_ADMIN' } },
    ...
    { path: '/financial/settlements', name: 'FinancialSettlements', component: () => import('@/views/financial/FinancialSettlements.vue'), meta: { requiresAuth: true, role: 'ADMIN', requiresModule: 'FINANCIAL' } },
...
const PAGE_TITLES = [
  ...
  ['/riders/new', 'Novo Entregador'],
  ['/riders/map', 'Mapa de Entregas'],
  ['/riders', 'Entregadores'],
  ['/rider-adjustments', 'Créditos / Débitos'],
  ['/rider/orders', 'Minhas Entregas'],
  ['/rider/home', 'QR Code'],
  ...
  ['/inbox', 'Atendimento'],
  ['/menu/menus', 'Cardápio'],
  ['/menu/admin', 'Painel do Cardápio'],
  ['/menu/products', 'Produto'],
  ['/menu/categories', 'Categoria'],
  ['/menu/options', 'Opções'],
  ['/menu/integration', 'Integração de Cardápio'],
  ['/sales', 'Histórico de Vendas'],
  ['/reports/cash-fronts', 'Frentes de Caixa'],
  ['/reports/products', 'Produtos Mais Vendidos'],
  ['/reports/menu-performance', 'Desempenho do Cardápio'],
  ['/reports/riders-dashboard', 'Dashboard de Entregadores'],
  ['/reports/rider-checkins', 'Check-ins'],
  ['/reports/rider-ranking', 'Ranking de Entregadores'],
  ['/ingredient-groups', 'Grupos de Ingredientes'],
  ['/ingredients', 'Ingredientes'],
  ['/technical-sheets', 'Fichas Técnicas'],
  ['/stock-movements', 'Movimentos de Estoque'],
  ['/stock/purchase-imports', 'Importação de Compras'],
  ['/stock/suppliers', 'Fornecedores'],
  ['/affiliates', 'Afiliados'],
  ['/coupons', 'Cupons'],
  ['/marketing/studio-ia', 'Studio IA'],
  ['/marketing/brand-themes', 'Temas Visuais'],
  ['/marketing/segments', 'Segmentos'],
  ['/marketing/segments/new', 'Novo Segmento'],
  ['/marketing/campaigns', 'Campanhas'],
  ['/marketing/campaigns/new', 'Nova Campanha'],
  ['/marketing/menu-notifications', 'Avisos no Cardápio'],
  ['/integrations', 'Integrações'],
  ['/settings/neighborhoods', 'Taxas de Entrega'],
  ['/settings/dados-fiscais', 'Dados Fiscais'],
  ['/settings/payment-methods', 'Formas de Pagamento'],
  ['/settings/stores', 'Lojas'],
  ...
  ['/financial/health', 'Saúde do Negócio'],
  ...
  ['/financial/settlements', 'Repasses Marketplace'],
  ['/financial', 'Financeiro'],
  ['/relatorios/nfe-emissoes', 'Notas Fiscais'],
  ['/nfe/emissao', 'Emissão de NF-e'],
  ['/saas/plans', 'Planos'],
  ['/saas/companies', 'Empresas'],
  ['/saas/modules', 'Módulos'],
  ['/saas/billing', 'Cobrança'],
  ['/saas/gateway', 'Gateway'],
