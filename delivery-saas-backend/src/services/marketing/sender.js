...
// BACKEND_URL is the codebase-wide convention (routes/inbox.js uses it for
// the same purpose — building public media URLs that ship to WhatsApp);
// PUBLIC_API_URL / SERVER_BASE_URL kept as fallbacks for parity with
// utils.generateQrUrl.
